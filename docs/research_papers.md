...
| 5 | **Zhao et al. 2023**, "Learning Fine-Grained Bimanual Manipulation with Low-Cost Hardware" (ACT), arXiv:2304.13705 | `drona/interaction/act_policy.py`, `notebooks/04_model_training.ipynb` | ACT (action-chunking transformer) is the imitation-learning policy for smoother gestures than the keyframe baseline (C3) |
| 6 | **Chi et al. 2023**, "Diffusion Policy", arXiv:2303.04137 | `drona/interaction/diffusion_policy.py`, `notebooks/04_model_training.ipynb` | Diffusion Policy is the C3 ablation comparison to ACT |
